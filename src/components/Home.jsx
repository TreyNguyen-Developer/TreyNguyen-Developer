  ...
  return (
    <div name='home' className='w-full h-screen bg-[#0a192f]'>
      ...
      <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
        ...
        <div>
          <Link to="work" smooth={true} duration={500} className='w-max text-white group border-2 px-6 py-3 my-2 flex items-center hover:border-yellow-200 hover:text-yellow-200'>View Work 
